...
const float Xmax = 0.75e-3; // Maximum displacement definition (Xmax) [m]
...
const int nAttack        = 1.2f * Fs * attackTime;
...
void Operations(void)
{
  ...
  valDAC = (uint16_t)((delayLine.read(nAttack) + VrefDAC)*conversionConstDAC);
