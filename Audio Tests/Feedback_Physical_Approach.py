...
from lib import dynamic_peak_follower2, gain_factor_smoothing_sbs_bis, dynamic_peak_follower_sbs, gain_factor_smoothing_sbs
import sys
...
v = sig.chirp(t, f0=10000, f1=10, t1=5, method='logarithmic')
...
release_peak   = 0.5         # Release time in seconds
