...
Cms_target[int(t_start*Fs):int(t_end*Fs)] = 0.5
...
ax.annotate('', xy=(t_fall_end*1e3, 0.75), xytext=(t_fall_start*1e3, 0.75), arrowprops=dict(arrowstyle='<->'))
ax.annotate(r'$t_a$', xy=(t_fall_start*1e3 + (t_fall_end*1e3 - t_fall_start*1e3)/2 - 2, 3/2 * 0.51))

ax.annotate('', xy=(t_rise_end*1e3, 0.75), xytext=(t_rise_start*1e3, 0.75), arrowprops=dict(arrowstyle='<->'))
ax.annotate(r'$t_r$', xy=(t_rise_start*1e3 + (t_rise_end*1e3 - t_rise_start*1e3)/2 - 2, 3/2*0.51))
