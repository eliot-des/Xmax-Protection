...
plt.tight_layout()
# fig.savefig('XOuUIn_Conly.pdf', bbox_inches='tight', pad_inches=0)
fig.savefig('XOuUIn_CandR_test.pdf', format='pdf', bbox_inches='tight', pad_inches=0)
